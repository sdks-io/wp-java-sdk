...
| `ArrivalDate` | `LocalDate` | Optional | The date when funds or securities are delivered to complete the transaction. | LocalDate getArrivalDate() | setArrivalDate(LocalDate arrivalDate) |
| `SettlementType` | `String` | Optional | The classification of the transaction processing method for financial reconciliation.<br><br>**Constraints**: *Maximum Length*: `1` | String getSettlementType() | setSettlementType(String settlementType) |
| `SignatureDebitConversion` | `Boolean` | Optional | Process of converting debit card transactions to signature based transactions. Possible values are True or False. | Boolean getSignatureDebitConversion() | setSignatureDebitConversion(Boolean signatureDebitConversion) |
| `TerminalId` | `String` | Optional | The unique 15-digit identification number for the terminal.<br><br>**Constraints**: *Maximum Length*: `15` | String getTerminalId() | setTerminalId(String terminalId) |
| `TerminalAddress` | `String` | Optional | The location identifier or address for the physical point-of-sale device or processing equipment.<br><br>**Constraints**: *Maximum Length*: `40` | String getTerminalAddress() | setTerminalAddress(String terminalAddress) |
| `TerminalCity` | `String` | Optional | The city where the physical point-of-sale device or processing equipment is located.<br><br>**Constraints**: *Maximum Length*: `28` | String getTerminalCity() | setTerminalCity(String terminalCity) |
| `TerminalState` | `String` | Optional | The state where the physical point-of-sale device or processing equipment is located.<br><br>**Constraints**: *Maximum Length*: `2` | String getTerminalState() | setTerminalState(String terminalState) |
...
| `OldAuthorizationAmount` | `Double` | Optional | The amount of the previous transaction a merchant submitted to the customer's issuing bank for approval. | Double getOldAuthorizationAmount() | setOldAuthorizationAmount(Double oldAuthorizationAmount) |
...
| `CashbackAmount` | `Double` | Optional | The amount refunded to the cardholder's account that is a small percentage of the sum spent on purchases.<br><br>**Constraints**: `>= 0`, `<= 99999999.99` | Double getCashbackAmount() | setCashbackAmount(Double cashbackAmount) |
| `GratuityAmount` | `Double` | Optional | The additional amount given in appreciation for a service.<br><br>**Constraints**: `>= 0`, `<= 99999999.99` | Double getGratuityAmount() | setGratuityAmount(Double gratuityAmount) |
| `NetworkId` | `String` | Optional | Indicates network id<br><br>**Constraints**: *Maximum Length*: `5` | String getNetworkId() | setNetworkId(String networkId) |
| `NetworkGroup` | [`NetworkGroup`](../../doc/models/network-group.md) | Optional | - | NetworkGroup getNetworkGroup() | setNetworkGroup(NetworkGroup networkGroup) |
| `OriginalReAuthorizationReason` | `String` | Optional | The initial justification for reauthorizing a transaction.<br><br>**Constraints**: *Maximum Length*: `1` | String getOriginalReAuthorizationReason() | setOriginalReAuthorizationReason(String originalReAuthorizationReason) |
| `VoucherNumber` | `String` | Optional | The unique reference number associated with a voucher.<br><br>**Constraints**: *Maximum Length*: `10` | String getVoucherNumber() | setVoucherNumber(String voucherNumber) |
| `PosConditionCode` | [`PosConditionCode`](../../doc/models/pos-condition-code.md) | Optional | - | PosConditionCode getPosConditionCode() | setPosConditionCode(PosConditionCode posConditionCode) |
| `ToAccountType` | [`CodeAndDescription`](../../doc/models/code-and-description.md) | Optional | The unique identifier and the brief description. | CodeAndDescription getToAccountType() | setToAccountType(CodeAndDescription toAccountType) |
| `FromAccountType` | [`CodeAndDescription`](../../doc/models/code-and-description.md) | Optional | The unique identifier and the brief description. | CodeAndDescription getFromAccountType() | setFromAccountType(CodeAndDescription fromAccountType) |
| `RemainingBalance` | `Double` | Optional | The amount still owed after a payment.<br><br>**Constraints**: `>= 0`, `<= 999999999.99` | Double getRemainingBalance() | setRemainingBalance(Double remainingBalance) |
| `Settled` | `Boolean` | Optional | If a financial transaction is completed and settled. | Boolean getSettled() | setSettled(Boolean settled) |
| `PinLess` | [`PinLess`](../../doc/models/pin-less.md) | Optional | - | PinLess getPinLess() | setPinLess(PinLess pinLess) |
| `AccountNameInquiry` | [`AccountNameInquiry`](../../doc/models/account-name-inquiry.md) | Optional | - | AccountNameInquiry getAccountNameInquiry() | setAccountNameInquiry(AccountNameInquiry accountNameInquiry) |
| `MastercardTransactionLinkId` | `String` | Optional | The unique identifier associated with a specific transaction that helps in tracking and reconciling payments across different systems.<br><br>**Constraints**: *Maximum Length*: `22` | String getMastercardTransactionLinkId() | setMastercardTransactionLinkId(String mastercardTransactionLinkId) |
...
```json
{
  ...
  "settlementType": "B",
  "signatureDebitConversion": true,
  "terminalId": "90A12312376548",
  "terminalAddress": "210 11TH ST",
  "terminalCity": "HUNTINGTON",
  "terminalState": "WV",
  "tieBreaker": "AB3645",
  ...
  "gratuityAmount": 1.33,
  "networkId": "STAR",
  "originalReAuthorizationReason": "X",
  "voucherNumber": "484426",
  "remainingBalance": 9.09,
  "settled": false,
  "mastercardTransactionLinkID": "7412589630123456789234",
